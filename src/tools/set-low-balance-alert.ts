...
export async function handleSetLowBalanceAlert(args: { project_id: string; signer_id: string; threshold_wei: string }): Promise<{ content: Array<{ type: "text"; text: string }>; isError?: boolean }> {
  try {
