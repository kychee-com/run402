...
export async function handleSetRecoveryAddress(args: { project_id: string; signer_id: string; recovery_address: string | null }): Promise<{ content: Array<{ type: "text"; text: string }>; isError?: boolean }> {
  try {
