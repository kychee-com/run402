...
export async function handleProvisionSigner(args: { project_id: string; chain: "base-mainnet" | "base-sepolia"; recovery_address?: string }): Promise<{ content: Array<{ type: "text"; text: string }>; isError?: boolean }> {
  try {
