# run402-error-envelope Specification

## Purpose

Define canonical machine-readable Run402 error handling across the SDK, CLI, MCP server, deploy translation, and agent-facing docs so agents can branch on stable codes and make safe retry decisions.
