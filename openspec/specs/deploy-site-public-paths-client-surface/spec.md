# deploy-site-public-paths-client-surface Specification

## Purpose
Define the public SDK, CLI, MCP, OpenClaw, and agent-documentation contract for authoring static browser URLs separately from release static asset paths.
