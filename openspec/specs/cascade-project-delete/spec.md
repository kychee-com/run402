...
- **THEN** the platform SHALL cascade-delete all resources (Lambda, subdomain, mailbox, etc.) before marking the project archived, using the same logic as explicit deletion
