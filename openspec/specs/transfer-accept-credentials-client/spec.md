# transfer-accept-credentials-client Specification

## Purpose
TBD - created by archiving change repoint-functions-deploy-and-transfer-keys. Update Purpose after archive.
## Requirements
