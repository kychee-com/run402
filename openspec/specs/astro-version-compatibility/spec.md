...
## Purpose
Define the supported Astro major-version contract for `@run402/astro`, including peer ranges, validation against the latest supported major, starter scaffold dependency freshness, and documentation boundaries for Astro-specific runtime features.
