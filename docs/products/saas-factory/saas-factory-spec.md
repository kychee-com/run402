...
**Reference implementation.** `kychee-com/kychon-private/docs/run402-feedback.md` (14 items as of 2026-04-14) is the canonical example. It surfaced the lifecycle-hooks gap that is now shipped as run402's `on-signup` function trigger — a closed feedback loop from product demand to platform capability. It also surfaced the silent auto-archive / pin chicken-and-egg / orphaned custom-domain issues that triggered the 2026-04-14 kychon recovery (items 1-4).
