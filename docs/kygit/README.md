# KyGit protocol docs (vendored)

The vault protocol specification, threat model, and second-HPKE decision
...
(`docs/strategy/products/kygit/`), where the freeze program's alignment
...
doc surface in this repo; `src/tools/vault-copy.test.ts` pins the shipped
