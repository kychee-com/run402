...
| Cross-repo publication and clean installation | Docs/distribution | Hash-bound hosted evidence in `publication-evidence.json`; live app acceptance is separate | Verified 2026-09-17 |
