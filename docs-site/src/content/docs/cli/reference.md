...
`run402 up [--name <name>] [--project <id>] [--manifest <path>] [--dir <path>] [--tier <prototype|hobby|team>] [-y|--yes] [--check|--print-spec|--plan|--require-plan <id>] [--json|--json-stream|--human] [--quiet] [--allow-warning <code> ...] [--allow-warnings]`
