---
title: "Auth, billing, operator, doctor, logs"
description: "Command reference for auth, billing, contracts, message, agent, notifications, webhook-secret, operator, service, cache, doctor, dev, init astro, and logs."
order: 8
slice: ops
