...
// result.identity: { display_name, source }  — the principal's name: RUN402_AGENT_NAME, else a detected client, when empty; nothing is written when nothing is known (source "undetected")
