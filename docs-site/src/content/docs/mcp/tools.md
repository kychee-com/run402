...
- `claim_subdomain` — claim `<name>.run402.com`. Idempotent; auto-reassigns to latest deploy on subsequent deploys. Params: `project_id`, `name`, `release_id?`, `deployment_id?` — omit both to bind the project's live release.
