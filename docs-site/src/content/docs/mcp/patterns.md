...
| `ROUTE_TARGET_CARRIED_FORWARD` | Carried-forward route still targets a base-release function. | Inspect `deploy_releases_active` and deploy a replacement route table if needed. |
