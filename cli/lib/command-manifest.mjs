...
export const COMMAND_MANIFEST = [
  ...
  { path: ["buzz", "join"], positionals: [], projectScoped: false, legacyPositionalProject: false, minimalArgs: ["--installation", "buzzci_11111111111111111111111111111111", "--identity-link", "idlnk_11111111111111111111111111111111", "--auth-tag", "[\"auth\",\"11\",\"\",\"22\"]"], skipBehavioral: "requires a live relay membership read and an owner attestation" },
  ...
  { path: ["buzz", "notifications", "projects"], positionals: [p("buzz_project_event_route_id")], projectScoped: false, legacyPositionalProject: false, minimalArgs: ["buzzper_11111111111111111111111111111111", "--add", "prj_1"], skipBehavioral: "requires live owner authentication and a live route" },
  { path: ["buzz", "notifications", "scope"], positionals: [p("buzz_project_event_route_id")], projectScoped: false, legacyPositionalProject: false, minimalArgs: ["buzzper_11111111111111111111111111111111", "--org"], skipBehavioral: "requires live owner authentication and a live route" },
  ...
  { path: ["grants", "list"], positionals: [], projectScoped: true, legacyPositionalProject: true, minimalArgs: [] },
  { path: ["grants", "revoke"], positionals: [p("grant_id")], projectScoped: true, legacyPositionalProject: true, minimalArgs: ["grt_gate1"] },
  { path: ["grants", "revoke-key"], positionals: [p("key_id")], projectScoped: true, legacyPositionalProject: true, minimalArgs: ["key_gate1"] },
  { path: ["grants", "rotate-key"], positionals: [p("key_id")], projectScoped: true, legacyPositionalProject: true, minimalArgs: ["key_gate1"] },
