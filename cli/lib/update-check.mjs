...
export async function doctorUpdateCheck({
  ...
  if (isUpdateOptedOut(env)) {
    return {
      ...
      value: {
        ...
        install_confidence_basis: "installation_method_detection",
        install_confidence_message: "Confidence in how this CLI was installed, independent of registry version comparison.",
  ...
  return {
    ...
    value: {
      current,
      latest_known: record.latest ?? null,
      comparison: comparison === null ? "unknown" : comparison > 0 ? "ahead_of_observation" : comparison < 0 ? "behind" : "equal",
