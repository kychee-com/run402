...
import { randomBytes, ed25519PublicKey, ekFingerprint, toBase64url } from "../namespaces/vault.crypto.js";
...
describe("sealHandoffEnvelopeV2 / openHandoffEnvelopeV2 (vault-multi-writer D4 — 'no hash cycle: grant first, then seal')", () => {
  const idBytes = uuidToBytes(HANDOFF_ID);
