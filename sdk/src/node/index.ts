...
export function run402(opts: NodeRun402Options = {}): NodeRun402 {
  ...
  (base as unknown as { wallets: NodeWallets }).wallets = new NodeWallets(client, {
    clientFor: ({ walletPath, keystorePath }) =>
      run402({ ...opts, credentials: undefined, paymentSigner: undefined, walletPath, keystorePath }),
  });
