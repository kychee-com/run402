 ...
 *
 * Run: node --test --import tsx sdk/src/namespaces/repos-handoff-wire.test.ts
 */
import { describe, it } from "node:test";
import assert from "node:assert/strict";

import { handoffMembershipFromWire, handoffVaultFromWire } from "./repos.js";
...
const MINT_RESPONSE = {
  ...
  next_actions: [{ type: "revoke_handoff", why: "…", method: "DELETE", path: "/vaults/v1/src_777c3254203e2ae80cfb302a2810791b/handoffs/a3266fe6-31ca-4ed0-b3b8-cbe41525e472" }],
};
