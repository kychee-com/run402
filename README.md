...
| `pin_project` | Pin a project idempotently (project-owner service key when local, otherwise platform-admin allowance auth; response may include `pinned` and `was_pinned`). |
