...
const MATRIX = {
  ...
  jobs: { shared: [], specific: ["submit", "get", "logs", "cancel", "purge", "artifacts"] },
  assets: {
    shared: [],
  ...
  repos: { shared: ["create", "list", "view", "rename", "delete", "capture", "policy", "mirror", "fsck", "gc", "access", "recover"], specific: [] },
