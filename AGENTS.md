...
- **Buzz integration** (`integrations/run402-for-buzz/`) — repository-local skill, dual-proof fixture/helper, security contract, and feedback-board reference app for publicly attributing an independent Buzz/Nostr identity to the active Run402 EOA. It never accepts or derives from a Nostr private key, and the link grants no authority.
